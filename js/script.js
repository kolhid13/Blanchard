$(document).ready(function(){
    ...
    var heroNav = document.getElementsByClassName("hero-menu-list__item");
    var menuActives = document.getElementsByClassName("hero-menu-list-active");
    for (i = 0; heroNav.length > i; i++){
        heroNav[i].onclick = function(){
            var currentActive = menuActives[0];
            if (currentActive)
            currentActive.classList.remove("hero-menu-list-active");

            if (currentActive !==this)
            this.classList.add("hero-menu-list-active");
        };
    }
    ...
    const modalBtns =  document.querySelectorAll('.overlay');
